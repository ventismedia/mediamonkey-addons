import type { Button, Edit } from 'declarations/types/Controls';

type UIConfigItems = {
    editOutputFile: ElementWith<Edit>,
    outputBefore: ElementWith<Edit>,
    outputAfter: ElementWith<Edit>,
    btnOutputFile: ElementWith<Button>,
}
...
window.configInfo = {
    ...
    load: function (panel, addon) {
        ...
        var UI = getAllUIElements(panel) as UIConfigItems;
